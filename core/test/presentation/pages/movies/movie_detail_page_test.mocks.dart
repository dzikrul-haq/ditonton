...
import 'package:core/domain/entities/movie_detail.dart' as _i4;
...
class MockMovieDetailCubit extends _i1.Mock implements _i2.MovieDetailCubit {
  ...
  _i3.Future<void> getSaveStatus(int? id) =>
      (super.noSuchMethod(Invocation.method(#getSaveStatus, [id]),
          ...
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  _i3.Future<void> addWatchlist(_i4.MovieDetail? movie) =>
      (super.noSuchMethod(Invocation.method(#addWatchlist, [movie]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
  @override
  dynamic removeWatchlist(_i4.MovieDetail? movie) =>
